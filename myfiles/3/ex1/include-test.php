...
<body>
<div class="container">
<?php # Template for starting a new php file template.php
/*============================================================
 |
 |	This is a big intro box used to introduce the following
 |	function and or purpose of this file. This box is made
 |	for prioritizing the documentation of this work.
 |
 ============================================================*/
...
echo 'This page works :)' . $br;
// Test if the include file path works!
include('../ex2/text.inc.php');
