...
$price = 119.95;
$taxrate = .5; // 5% sales tax

// Calculate the total:
$total = $quantity *  $price;
// Procent regning. K = k + (k * r)
...
// Print thr result:
echo '<p>You are purchashin <strong>' . $quantity . '</strong> widget(s) at a cost of <strong>$' . $price . '</strong> each. With tax, the total comes to <strong>$' . $total . '</strong></p>';

echo '<br>';
/*	New in PHP 7 is the intdiv() function, 
	wich returns the integer quotient of a division:
*/
	echo intdiv(7, 3); // 2
